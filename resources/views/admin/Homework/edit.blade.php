                                            ...
                                            <!-- Email Address -->
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <div class="mt-1 relative rounded-md shadow-sm">
                                                        ...
                                                        <input type="text" name="price" id="custom_price" value="{{$homework->custom_price}}" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="0.00">
                                                    </div>
