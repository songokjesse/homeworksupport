                                        ...
                                        <div class=" flex flex-col sm:justify-center pt-6 sm:pt-0">
                                            ...
                                            <!-- Email Address -->
                                                <div class="mt-4">
                                                    ...
                                                    <x-input id="email" class="block mt-1 w-full" type="text" name="name" value="{{$user->name}}" required autofocus />
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <x-input id="email" class="block mt-1 w-full" type="password" name="password" :value="old('password')" />
                                                </div>
                                                {{-- confirm password--}}
                                                <div class="mt-4">
                                                    <x-label for="email" :value="__('Confirm Password')" class="sm:font-bold"/>
                                                    <x-input id="email" class="block mt-1 w-full" type="password" name="confirm-password" :value="old('confirm-password')"  />
                                                </div>
                                                {{-- Assign Roles--}}
                                                <div class="mt-4">
