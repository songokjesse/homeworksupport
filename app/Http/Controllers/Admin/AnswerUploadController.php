...
class AnswerUploadController extends Controller
{
    public function index($id)
    {
        ...
        return view('admin.Homework.answer', compact('homework','homework_id'));
    }
    public function store(Request $request)
    {
        ...
        $homeworkUpload->Answer = True;
        $homeworkUpload->save();

        $homework_id = $request->input('homework_id');
        return redirect()->route('AnswerUpload', ['id' => $homework_id]);
    }
